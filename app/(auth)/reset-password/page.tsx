    ...
    return (
      <div className="space-y-8 text-center animate-in fade-in zoom-in duration-300">
        ...
        <div className="bg-[#111111] border border-white/5 rounded-3xl p-8">
           <Link
            href="/login"
            className="w-full bg-[#155DFC] text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all"
          >
            Go to Login
          </Link>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-zinc-500 text-sm">Must be at least 8 characters long.</p>
      </div>
      ...
      <div className="bg-[#111111] border border-white/5 rounded-3xl p-8 shadow-2xl shadow-blue-500/5">
        <form onSubmit={handleReset} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-[#155DFC] transition-colors" size={20} />
              <input
                required
                type="password"
                placeholder="••••••••"
